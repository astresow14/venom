...
export default function BuildsNewPage() {
  ...
  const { data: sopsResponse } = useListVenomSops();
  const apps = asList(appsResponse);
  const sops = asList(sopsResponse);
  const { data: appDetail } = useGetVenomApp(appId, {
  ...
  useEffect(() => {
    if (appDetail?.versions && appDetail.versions.length > 0 && !sourceVersionId) {
  ...
  }, [appDetail, brandDirection, targetName]);
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="rounded-sm border-border/60 focus-visible:ring-2 h-10 shadow-soft"
                  maxLength={120}
                  required
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col gap-2">
                  <select
                    ...
                    className="flex h-10 w-full border border-border/60 bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 appearance-none rounded-sm shadow-soft"
                  >
                  ...
                  {appId && appDetail?.versions && (
                    <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                      ...
                      <select
                        ...
                        className="flex h-10 w-full border border-border/60 bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring appearance-none rounded-sm shadow-soft"
                      >
